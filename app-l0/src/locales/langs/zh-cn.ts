const local: App.I18n.Schema = {
  ...
  route: {
    ...
    llm_project: '项目管理',
    'llm_app-client': '应用管理',
    'llm_api-key': 'API Key 管理',
    llm_provider: '厂商管理',
    gateway: '网关管理',
    gateway_cache: '网关缓存',
    'gateway_routing-config': '路由配置',
    'gateway_whitelist-recommend': '智能推荐',
    system_tenant: '租户管理',
  ...
  page: {
    ...
    home: {
      ...
      projectNews: {
        title: '项目动态',
        moreNews: '更多动态',
        desc1: 'AI-FinOps（afo）完成前端项目初始化。',
        desc2: 'afo 完成多标签栏与动态路由适配。',
        desc3: 'AI-FinOps 接入系统权限与租户管理能力。',
        desc4: 'afo 正在完善 AI 成本洞察与运营看板。',
        desc5: 'AI-FinOps 持续优化资源、预算和账单分析体验。'
      },
      creativity: '创意'
    },
    common: {
    ...
    llm: {
      model: {
        ...
        supportsTool: '支持工具',
        supportsVision: '支持视觉',
        supportsParallelFunctionCalling: '并行FC',
        supportsReasoning: '支持推理',
        maxInputTokens: '最大输入Token',
        maxOutputTokens: '最大输出Token',
        apiVersion: 'API 版本',
        rateLimitTpm: 'TPM 限制',
        rateLimitRpm: 'RPM 限制',
        ...
        form: {
          ...
          litellmModel: {
            required: '请输入 LiteLLM 模型',
            invalid: 'LiteLLM 模型不能为空'
          },
          modelType: {
            required: '请输入模型类型',
            invalid: '模型类型不能为空'
      ...
      appClient: {
        ...
        addAppClient: '新增应用客户端',
        editAppClient: '编辑应用客户端'
      },
      apiKey: {
        title: 'API Key 管理',
        keyId: 'Key ID',
        ...
        createTime: '创建时间',
        statusChangeSuccess: '状态修改成功',
        generatedKeyTitle: 'API Key 已生成',
        generatedKeyTip: '请立即复制保存，关闭后无法再次查看明文。',
        copyKey: '复制 Key',
        form: {
          keyId: {
            required: '请输入 Key ID',
    ...
    gateway: {
      cacheConfig: {
        ...
        matchMode: '匹配模式',
        matchModeExact: '精确匹配',
        matchModeSemantic: '语义相似',
        similarityThreshold: '相似度阈值',
        ttlSeconds: '缓存有效期(秒)',
        maxEntries: '最大条目数',
        totalHits: '命中次数',
        totalMisses: '未命中次数',
        estimatedTokensSaved: '节省 Token 数',
        hitRate: '命中率',
        totalEntries: '缓存条目数',
        purge: '清空缓存',
        purgeConfirm: '确认清空该项目下的所有缓存条目？',
        purgeSuccess: '缓存已清空',
        stats: '统计概览',
        addConfig: '新增配置',
        editConfig: '编辑配置',
        scopeHint: '应用级配置优先于项目级配置',
        enabledStatus: {
          enabled: '启用',
          disabled: '停用'
        },
        form: {
          projectId: { required: '请选择项目', invalid: '项目不能为空' },
          enabled: { required: '请选择启用状态', invalid: '启用状态不能为空' },
          matchMode: { required: '请选择匹配模式', invalid: '匹配模式不能为空' },
          ttlSeconds: { required: '请输入缓存有效期', invalid: '缓存有效期不能为空' },
          maxEntries: { required: '请输入最大条目数', invalid: '最大条目数不能为空' },
          similarityThreshold: { required: '请输入相似度阈值', invalid: '相似度阈值不能为空' }
        }
      },
      cacheEntry: {
        title: '缓存条目',
      ...
      whitelistRecommend: {
        title: '智能推荐',
        cardTitle: '白名单智能推荐',
        addToWhitelist: '一键添加白名单',
        ignore: '忽略',
        acceptSuccess: '规则已加入试运行白名单，观察 3 天后可正式启用',
        acceptFail: '操作失败，该推荐可能已被处理',
        ignoreSuccess: '已忽略该推荐',
        requestCount: '{count} 次',
        avgConfidence: '平均置信度 {pct}%',
        pattern: '推荐正则',
        emptyTitle: '暂无智能推荐',
        emptyDesc: '系统正在积累数据，后台每天凌晨分析前 7 天影子对比数据，预计 24 小时后生成首批推荐...',
        keyword: '关键词',
        sourcePath: '来源路径',
        accepted: '已添加',
        rejected: '已忽略',
    ...
    about: {
      title: '关于',
      introduction: `AI-FinOps（afo）是面向 AI 场景的 FinOps 管理平台，聚焦成本洞察、资源运营、预算管控和财务治理，为团队提供统一的 AI 支出分析与优化入口。`,
      projectInfo: {
        title: '项目信息',
        version: '版本',
