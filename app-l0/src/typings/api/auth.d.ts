declare namespace Api {
  ...
  namespace Auth {
    ...
    /** sms login form */
    interface SmsLoginForm extends LoginForm {
      /** 手机号 */
      phonenumber?: string;
      /** 短信验证码 */
      smsCode?: string;
    ...
    /** email login form */
    interface EmailLoginForm extends LoginForm {
      /** 邮箱 */
      email?: string;
      /** 邮箱验证码 */
      emailCode?: string;
    ...
    /** leave tenant result */
    interface TenantLeaveResult {
      /** whether user still has another tenant */
      hasTenant: boolean;
      /** switched login token */
      loginVo?: LoginToken;
    }
