      ...
      page: {
        ...
        llm: {
          model: {
            ...
            supportsParallelFunctionCalling: string;
            ...
            form: {
              ...
              provider: FormMsg;
              supplier: FormMsg;
              litellmModel: FormMsg;
              modelType: FormMsg;
              contextWindow: FormMsg;
              status: FormMsg;
              remark: FormMsg;
            };
            addModel: string;
          ...
          provider: {
            ...
            form: {
              providerId: FormMsg;
              providerName: FormMsg;
              modelPrefixes: FormMsg;
              status: FormMsg;
            };
            addProvider: string;
            editProvider: string;
        ...
        gateway: {
          cacheConfig: {
            ...
            enabled: string;
            matchMode: string;
            matchModeExact: string;
            matchModeSemantic: string;
            ...
            editConfig: string;
            scopeHint: string;
            enabledStatus: Record<string, string>;
            form: {
              projectId: FormMsg;
              enabled: FormMsg;
              matchMode: FormMsg;
