...
export const useAuthStore = defineStore(SetupStoreId.Auth, () => {
  ...
  async function login(
    loginForm: Api.Auth.PwdLoginForm | Api.Auth.SmsLoginForm | Api.Auth.EmailLoginForm | Api.Auth.SocialLoginForm,
    redirect = true
  ) {
    startLoading();
    ...
    } as Api.Auth.PwdLoginForm | Api.Auth.SmsLoginForm | Api.Auth.EmailLoginForm | Api.Auth.SocialLoginForm;
