...
public class VelocityUtils {
    ...
    public static String getFileName(String template, GenTable genTable) {
        ...
        String afoPath = "afo";
        String afoModuleName = StrUtil.toSymbolCase(moduleName, '-');
        ...
        if (template.contains("mapper.java.vm")) {
            ...
            fileName = StringUtils.format("{}/views/{}/{}/index.vue", afoPath, afoModuleName, StrUtil.toSymbolCase(businessName, '-'));
        } else if (template.contains("index-tree.vue.vm")) {
            fileName = StringUtils.format("{}/views/{}/{}/index.vue", afoPath, afoModuleName, StrUtil.toSymbolCase(businessName, '-'));
        } else if (template.contains("api.d.ts.vm")) {
            fileName = StringUtils.format("{}/typings/api/{}.{}.api.d.ts", afoPath, afoModuleName, StrUtil.toSymbolCase(businessName, '-'));
        } else if (template.contains("api.ts.vm")) {
            fileName = StringUtils.format("{}/service/api/{}/{}.ts", afoPath, afoModuleName, StrUtil.toSymbolCase(businessName, '-'));
        } else if (template.contains("search.vue.vm")) {
            fileName = StringUtils.format("{}/views/{}/{}/modules/{}-search.vue", afoPath, afoModuleName, StrUtil.toSymbolCase(businessName, '-'), StrUtil.toSymbolCase(businessName, '-'));
        } else if (template.contains("operate-drawer.vue.vm")) {
            fileName = StringUtils.format("{}/views/{}/{}/modules/{}-operate-drawer.vue", afoPath, afoModuleName, StrUtil.toSymbolCase(businessName, '-'), StrUtil.toSymbolCase(businessName, '-'));
        }
        return fileName;
    }
