package org.afo.system.service;
...
public interface ISysUserService {
     ...
     * @return 结果
     */
    int bindUserToCurrentTenant(SysUserBo user);
     ...
     * @return 结果
     */
    int removeUsersFromCurrentTenant(Long[] userIds);
     ...
     * @param userId 用户ID
     */
    void leaveCurrentTenant(Long userId);
     ...
     * @param tenantId 租户ID
     */
    void leaveTenant(Long userId, String tenantId);
