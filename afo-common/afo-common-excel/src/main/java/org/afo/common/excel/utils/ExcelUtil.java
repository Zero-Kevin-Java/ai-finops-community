package org.afo.common.excel.utils;
...
import org.afo.common.core.utils.file.FileUtils;
import org.afo.common.excel.convert.ExcelBigNumberConvert;
import org.afo.common.excel.convert.ExcelLocalTimeConvert;
import org.afo.common.excel.core.*;
import org.afo.common.excel.handler.DataWriteHandler;
...
public class ExcelUtil {
    ...
    public static <T> void exportExcel(List<T> list, String sheetName, Class<T> clazz, boolean merge,
        ...
        ExcelWriterSheetBuilder builder = FastExcel.write(os, clazz)
            ...
            .registerConverter(new ExcelLocalTimeConvert())
