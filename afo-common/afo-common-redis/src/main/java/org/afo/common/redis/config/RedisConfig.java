...
import org.afo.common.redis.handler.KeyPrefixHandler;
import org.afo.common.redis.handler.RedisExceptionHandler;
...
public class RedisConfig {
    ...
    public RedissonAutoConfigurationCustomizer redissonCustomizer() {
        return config -> {
            ...
            //}
            normalizeBlankPassword(config, redisProperties);
    ...
    static void normalizeBlankPassword(Config config, RedisProperties redisProperties) {
        if (redisProperties == null || StringUtils.hasText(redisProperties.getPassword())) {
            return;
        }
